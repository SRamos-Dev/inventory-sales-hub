...
import com.github.inventorysaleshub.model.dto.MostProfitableProductDTO;
import com.github.inventorysaleshub.model.dto.TopProductDTO;
...
public interface OrderDetailsRepository extends JpaRepository<OrderDetails, Long> {
    ...
    @Query("SELECT new com.github.inventorysaleshub.model.dto.TopProductDTO(" +
    ...
    @Query("SELECT new com.github.inventorysaleshub.model.dto.MostProfitableProductDTO(" +
